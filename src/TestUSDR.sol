...
/**
 * @title TestUSDR
 * @notice Test USDR token for testing purposes
 * @dev Allows owner to mint tokens for testing
 */
contract TestUSDR is ERC20, Ownable {
    uint8 private _decimals;

    constructor(address _owner) ERC20("Test USDG", "USDG") {
        _transferOwnership(_owner);
        _decimals = 6; // USDR has 6 decimals
        // Mint initial supply to deployer
        _mint(_owner, 1_000_000_000_000 * 10 ** _decimals); // 1 trillion USDR
    }
